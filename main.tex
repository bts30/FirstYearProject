...
\usepackage[left=2.3cm,top=1.8cm,bottom=1.8cm, right=2.3cm]{geometry}
%\usepackage{ulem}
...
%\titlespacing{\subsection}{0pt}{1.3ex}{0ex}
...
useful to take a moment to examine a simpler chaotic system in order to better understand what to expect of the chaotic effects that arise in the bouncing ball experiment.
