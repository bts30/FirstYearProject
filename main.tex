...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.75\textwidth]{dummy.png} \label{frq_vs_ampl_plot}
...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=\textwidth]{dummy.png} \label{nat_freq}
		\caption{Ring-out of the speaker membrane after a sharp collision.}
	\end{subfigure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.95\texwidth]{vsweep.eps}
\caption{Stable solution depends strongly on inital velocity. The system plottet here is simulated with $C_r=0.66$, $f=\SI{16}{\hz}$, $A=\SI{1.1}{\mili\meter}$.}
\end{figure}
